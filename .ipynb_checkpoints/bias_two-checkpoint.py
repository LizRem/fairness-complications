...
# load model 
model_path = "/data/scratch/hhz049/a_nephro_6months_gator"
...
# data
df = pd.read_csv("/data/scratch/hhz049/1-diabetes-complications/1-single_diseases/nephropathy_6_month.csv", index_col=0)
demo = pd.read_csv("/data/scratch/hhz049/data/demographics_clean_new.csv", index_col=0) 
