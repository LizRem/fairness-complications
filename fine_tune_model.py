...
# data
df = pd.read_csv("nephropathy_6_months.csv", index_col=0) # load correct dataset that has been cleaned
...
# calculate class weights on train dataset
...
# define custom trainer for BCE loss
...
model_name = "UFNLP/gatortron-base" # can replace with other pre-trained models =
